# TS Ignore Test Conclusion

## Comparison

- **Case A (`ts-ignore-test-a.md`)**: rule `@.cursor/rules/conventions.mdc` was active.
...
- **Case B (`ts-ignore-test-b.md`)**: rule `@.cursor/rules/conventions.mdc` was disabled.
